...
//#endregion
//#region node_modules/reveal.js-plugintoolkit/dist/plugintoolkit.mjs
...
var te = class {
	...
	initializeConfig(t) {
		...
		this.userConfigData = r, this.mergedConfig = (0, import_cjs.default)(n, r, {
			arrayMerge: (e, t) => t,
			clone: !0
		});
	}
...
var ne = (e) => document.querySelectorAll(`[${p}="${e}"]`).length > 0;
var re = 1e4;
var ie = (e) => Promise.resolve(g(e));
...
var v = (e = 1e3) => _() ? Promise.resolve(!0) : new Promise((t) => {
	let n = Date.now() + e, r = () => {
		if (_()) {
			t(!0);
			return;
...
var C = (e) => [`dist/plugin/${e}/${e}.css`, `plugin/${e}/${e}.css`];
var w = (e) => typeof e == "string" && e.trim() !== "";
var T = async (e, t) => {
...
var D = Symbol.for("reveal.js-plugintoolkit.directionEvents");
var O = Symbol.for("reveal.js-plugintoolkit.scrollModeEvents");
var k = (e, t, n) => {
...
var N = (e) => e instanceof HTMLElement && e.tagName === "SECTION";
var P = (e) => N(e) ? Array.from(e.children).some((e) => e instanceof HTMLElement && e.tagName === "SECTION") : !1;
var F = (e) => N(e) ? e.parentElement instanceof HTMLElement && e.parentElement.tagName === "SECTION" : !1;
var I = (e) => N(e) && !F(e) && !P(e);
var L = (e) => {
	if (!N(e)) return null;
	if (F(e)) {
...
var R = (e) => N(e) ? F(e) ? "vertical" : P(e) ? "stack" : "horizontal" : "invalid";
var z = /* @__PURE__ */ n({
	isJSON: () => B,
	toJSONString: () => V
});
...
var W = (e) => document.createRange().createContextualFragment(e).firstElementChild;
var le = /* @__PURE__ */ n({ sanitizeText: () => G });
var G = (e) => e.toLowerCase().replace(/\s+/g, "").replace(/[^\p{L}\p{N}-]/gu, "");
var ue = /* @__PURE__ */ n({ addThemeColor: () => $ });
var K = Symbol.for("reveal.js-plugintoolkit.themeColor");
var q = "has-light-background";
var J = "has-dark-background";
var de = "--c-theme-color";
var fe = "--c-theme-heading-color";
var pe = {
	text: "section",
	heading: "h1"
};
var me = "c-theme-inverted";
var he = "reveal-scroll";
var ge = "stack";
var Y = (e, t, n) => {
	Object.defineProperty(e, t, {
		value: n,
...
var X = (e, t) => e?.classList.contains(t) ?? !1;
var ve = (e, t, n) => {
	let r = X(n, he) ? n : t;
